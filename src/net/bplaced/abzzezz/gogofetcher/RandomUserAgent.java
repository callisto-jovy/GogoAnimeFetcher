...
public class RandomUserAgent {
    ...
    private static final Map<String, String[]> USER_AGENT_MAP = new HashMap<String, String[]>();
    private static final Map<String, Double> FREQ_MAP = new HashMap<String, Double>();

    static {

        FREQ_MAP.put("Internet Explorer", 11.8);
        FREQ_MAP.put("Firefox", 28.2);
        FREQ_MAP.put("Chrome", 52.9);
        FREQ_MAP.put("Safari", 3.9);
        FREQ_MAP.put("Opera", 1.8);

        USER_AGENT_MAP.put("Internet Explorer", new String[]{
        ...
        USER_AGENT_MAP.put("Firefox", new String[]{
        ...
        USER_AGENT_MAP.put("Chrome", new String[]{
        ...
        USER_AGENT_MAP.put("Safari", new String[]{
        ...
        USER_AGENT_MAP.put("Opera", new String[]{
    ...
    public static String getRandomUserAgent() {
        ...
        String browser = null;
        double count = 0.0;
        for (Entry<String, Double> freq : FREQ_MAP.entrySet()) {
            count += freq.getValue();
            if (rand <= count) {
                browser = freq.getKey();
                break;
